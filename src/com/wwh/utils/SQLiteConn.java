	...
	public Connection getConnection(String s) throws Exception {
		...
		try {
			...
			Class.forName("org.sqlite.JDBC");
			 ...
			 //stat.executeUpdate("create table storehouse (p_barcode varchar(20) primary key,p_name varchar(20) not null,p_producer varchar(20) not null,sale_price float,p_number int,p_text text,vip_price float,in_price float);");// 创建一个表，两列
